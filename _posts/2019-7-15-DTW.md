...
<img src="/assets/dtw/dtw_3.png" style="zoom:80%">
...
<img src="/assets/dtw/dtw_13.png" style="zoom:50%">
代码要点：
...
<img src="/assets/dtw/dtw_6.png" style="zoom:100%">
如上图所示，左图表示 $LB_{Kim}$ 下界，右图为使用了 $LB_{Keogh}$ 下界。$LB_{Keogh}$ 下界计算了候选子序列`C`和它的包络`{U,L}`之间欧几里得距离。
	...
	><img src="/assets/dtw/dtw_6.png" style="zoom:70%">
	...
	><img src="/assets/dtw/dtw_7.png" style="zoom:100%">
	>
